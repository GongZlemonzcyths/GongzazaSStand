...
getgenv().ResetConfigurations = function()
    if isfile("Alian_Hub_config.txt") then
        delfile("Alian_Hub_config.txt");
        BoredLibrary.prompt("Alian Hub 🌸","Configurations Deleted!",1.5);
    else
        BoredLibrary.prompt("Alian Hub 🌸","Configurations Doesn't Exist...",1.5);
    end
end
...
getgenv().SaveConfigurations = function()
    ...
    writefile("Alian_Hub_config.txt",Data);
    BoredLibrary.prompt("Alian Hub 🌸","Configurations Saved!",1.5);
end

getgenv().LoadConfigurations = function()
    if isfile("Alian_Hub_config.txt") then
        local Data = readfile("Alian_Hub_config.txt")
        ...
        BoredLibrary.prompt("Alian Hub ","Configurations Loaded!",1.5);
        ...
        BoredLibrary.prompt("Alian Hub 🌸","Configurations Not Found...",1.5);
    end
end
                ...
                if game:GetService("Players").LocalPlayer.Data.StandName.Value == "Standless" then
                    if game:GetService("Players").LocalPlayer.Data.Mastery.Value < 2 then
                        if workspace.Map.NPCs:FindFirstChild("Kuzma") then
                            ...
                            if not Prompt then
                                BoredLibrary.prompt("Alian Hub 🌸","Waiting for Kuzma To Spawn",1.5);Prompt = true;
                            end  
                        end
                    else
                        if not Prompt then
                            BoredLibrary.prompt("Alian Hub 🌸","Mastery is not Enough",1.5);Prompt = true;
                        end
                    end
                else
                    if not Prompt then
                        BoredLibrary.prompt("Alian Hub 🌸","You are not Standless",1.5);Prompt = true;
                    end
                end
            end)
            task.wait(0.45);
...
local MainWindow = DrRayLibrary:Load("Alian Hub   🌸","Default");
...
-- // Loaded Notification \\ --
BoredLibrary.prompt("Alian Hub 🌸","Current Version: "..getgenv().CurrentVersion,1.5);
---------------------------------[[ Main Source Code 💞 ]]------------------------------------------------------------
...
HomeTab.newButton("Script Made by Flames","",function()
    ...
    Sound.Volume = 10;Sound.Looped = false;Sound.Archivable = false;Sound.Parent = game.Workspace;Sound:Play();
    BoredLibrary.prompt("Alian Hub   🌸","Thank you Mommy Flames <3",1.5);
end)
...
HomeTab.newButton("Gui Library Made by Chillz","",function()
    ...
    Sound.Volume = 10;Sound.Looped = false;Sound.Archivable = false;Sound.Parent = game.Workspace;Sound:Play();
    BoredLibrary.prompt("Alian Hub   🌸","Thank you Daddy Chillz <3",0.5);
end)
...
HomeTab.newButton("Notify Library Made by Bored","",function()
    ...
    local Sound = Instance.new("Sound");Sound.Name = "Sound";Sound.SoundId = LoudFarts
    Sound.Volume = 10;Sound.Looped = false;Sound.Archivable = false;Sound.Parent = game.Workspace;Sound:Play();
    BoredLibrary.prompt("Alian Hub   🌸","Thank you Daddy Bored <3",0.5);
end)
...
HomeTab.newButton('Use Code: "'..Code1..'"','',function()
    BoredLibrary.prompt("Alian Hub  🌸","Used: "..Code1,1.5);
    local args = {Code1};
...
HomeTab.newButton('Use Code: "'..Code2..'"','',function()
    BoredLibrary.prompt("Alian Hub   🌸","Used: "..Code2,1.5);
    local args = {Code2};
    game:GetService("ReplicatedStorage"):WaitForChild("GlobalUsedRemotes"):WaitForChild("EnterCode"):FireServer(unpack(args));
end)

HomeTab.newButton('Use Code: "'..Code3..'"','',function()
    BoredLibrary.prompt("Alian Hub  🌸","Used: "..Code3,1.5);
    local args = {Code3};
    game:GetService("ReplicatedStorage"):WaitForChild("GlobalUsedRemotes"):WaitForChild("EnterCode"):FireServer(unpack(args));
end)

HomeTab.newButton('Use Code: "'..Code4..'"','',function()
    BoredLibrary.prompt("Alian Hub  🌸","Used: "..Code4,1.5);
    local args = {Code4};
    game:GetService("ReplicatedStorage"):WaitForChild("GlobalUsedRemotes"):WaitForChild("EnterCode"):FireServer(unpack(args));
end)

HomeTab.newButton('Use Code: "'..Code5..'"','',function()
    BoredLibrary.prompt("Alian Hub  🌸","Used: "..Code5,1.5);
    local args = {Code5};
    game:GetService("ReplicatedStorage"):WaitForChild("GlobalUsedRemotes"):WaitForChild("EnterCode"):FireServer(unpack(args));
end)

HomeTab.newButton('Use Code: "'..Code6..'"','',function()
    BoredLibrary.prompt("Alian Hub  🌸","Used: "..Code6,1.5);
    local args = {Code6};
    game:GetService("ReplicatedStorage"):WaitForChild("GlobalUsedRemotes"):WaitForChild("EnterCode"):FireServer(unpack(args));
end)

HomeTab.newButton('Use Code: "'..Code7..'"','',function()
    BoredLibrary.prompt("Alian Hub  🌸","Used: "..Code7,1.5);
    local args = {Code7};
    game:GetService("ReplicatedStorage"):WaitForChild("GlobalUsedRemotes"):WaitForChild("EnterCode"):FireServer(unpack(args));
end)

HomeTab.newButton('Use Code: "'..Code8..'"','',function()
    BoredLibrary.prompt("Alian Hub  🌸","Used: "..Code8,1.5);
    local args = {Code8};
    game:GetService("ReplicatedStorage"):WaitForChild("GlobalUsedRemotes"):WaitForChild("EnterCode"):FireServer(unpack(args));
end)
...
HomeTab.newButton("Auto find The Arbiter   🌟  (Copied to Clipboard)","",function()
    ...
    BoredLibrary.prompt("Alian Hub  🌸","Copied to clipboard",0.5);
end)
...
HomeTab.newButton("Auto One For All Finder   🦸  (PATCHED)","",function()
    ...
    BoredLibrary.prompt("Alian Hub  🌸","Patched, Wait for fix",0.5);
end)
...
HomeTab.newLabel("Alian Hub Stuff  🌸");
--HomeTab.newButton("Official Discord Server (Copied to Clipboard)","",function()
    --setclipboard("https://discord.gg/XcUFRW4DWH");
    --BoredLibrary.prompt("Alian Hub  🌸","Copied to clipboard",0.5);
--end)

HomeTab.newToggle("Alian Hub, Go Rainbow Please","",getgenv().AutoGoingRainbow or false,function(Value)
    getgenv().AutoGoingRainbow = Value
    getgenv().UsingRainbowUI();
end)

HomeTab.newButton("Alian Hub Changelogs GUI","",function()
    task.spawn(function()BoredLibrary.prompt("Alian Hub  🌸","Loading Changelogs...",0.75);end)
...
HomeTab.newButton("Reload Alian Hub","",function()
    task.spawn(function()BoredLibrary.prompt("Alian Hub  🌸","Reloading Hub...",0.75);end)
    getgenv().AlianHub = "https://raw.githubusercontent.com/Lvl9999/SakuraStand/main/SakuraHub";
...
HomeTab.newButton("Goodbye Alian Hub   👋","",function()
...
HomeTab.newLabel("Alian Hub Configs   ⚙️");
HomeTab.newButton("Save Alian Hub Config","",function()
    getgenv().SaveConfigurations();
end)

HomeTab.newButton("Reset Alian Hub Config","",function()
...
HomeTab.newInput("Report Bugs / Feedback","Type here anything you want me to know :)",function(text)
    ...
    task.spawn(function()
        if getgenv().Message ~= "" then
            ...
            BoredLibrary.prompt("Alian Hub  🌸","Message Sent   ✅",1.5);
        end
    end)
end)
...
HomeTab.newButton("Hide your username (Use Before Typing, Optional)","",function()
    if not getgenv().HidedName == true then getgenv().HidedName = true
        ...
        BoredLibrary.prompt("Alian Hub  🌸","Hided Your Name   ✅",1.5);
    end
end)
...
FarmingTab.newButton("Read This (Very Important)","",function()
    BoredLibrary.prompt("Alian Hub   🌸","Use one teleport toggle at a time!",1.5);
    task.spawn(function()
        ...
        Sound:Play();
    end)BoredLibrary.prompt("Alian Hub   🌸","Dont ask me about Menos  😡😡😡",2.5);task.wait(1.85);
    task.spawn(function()
...
FarmingTab.newButton("Equip Shinra Kusakabe (Best for Private Server Autofarm)","",function()
    pcall(function()
        if game:GetService("Players").LocalPlayer.Data.StandName.Value ~= "Shinra Kusakabe" then
            ...
            task.spawn(function()BoredLibrary.prompt("Alian Hub   🌸","You are Already Shinra Kusakabe",0.5);end);
        end
    end)
end)
...
FarmingTab.newButton("Quick Explanation (Open F9 Console)","",function()
    pcall(function()
        ...
        BoredLibrary.prompt("Alian Hub 🌸","Open F9 Console",1.5);
        warn("---------------[Auto Farming]---------------");
...
--FarmingTab.newToggle("Start Farming (With Support)","",getgenv().AutofarmOnDeku2 or false,function(Value)
    ...
    --if getgenv().AutofarmOnDeku2 == true then
        --BoredLibrary.prompt("Alian Hub 🌸","Soon, Wait for update.",1.5);
    --end
...
FarmingTab.newToggle("Auto Steal One For All (Requires Standless)","",getgenv().AutoStealingOfa or false,function(Value)
    ...
    if getgenv().AutoStealingOfa == true then
        BoredLibrary.prompt("Alian Hub 🌸","Patched, Wait for fix.",1.5);
    end
...
AreasTab.newButton("Bird","",function()
    pcall(function()
        if game:GetService("Workspace").Effects:FindFirstChild("Bird") then
            ...
            BoredLibrary.prompt("Alian Hub   🌸","The bird is not here :(",1);
        end
    end)
end)
